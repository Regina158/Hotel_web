<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">ARGANA HOTEL</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="contac.php">CONTACT US</a>
                </li>
            ...
            <div class="d-flex">
                <button type="button" class="btn btn-outline-dark shadow-none me-l-2 me-3" data-bs-toggle="modal"
            ...
            <form>
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Your details must match with your ID (NIK KTP, Passpord, Driving Licence (SIM), etc)
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 ps-0 mb-3">
                                <label class="from-label">No ID</label>
                                <input type="number" class="form-control shadow-none">
                            </div>
                            <div class="col-md-6 ps-0 mb-3">
